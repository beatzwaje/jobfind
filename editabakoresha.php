...
<body>
  ...
  <div class="logosec">
    ...
    <div class="dropdown-container">
      ...
      <a href="delete.php">Delete Job Listings</a>
    ...
    <div class="dropdown-container">
      <a href="abakoresha.php">View Employers</a>
      <a href="editabakoresha.php">Edit Employers</a>
...
<?php
        ...
        if (mysqli_num_rows($results) > 0) {
            echo '<table border="1">';
            echo '<tr><th>Email</th><th>Username</th><th>Employer Type</th><th>Employer Name</th><th>National ID</th><th>District</th><th>P.O. Box</th><th>Website</th><th>Province</th><th>Sector</th><th>Physical Address</th><th>Actions</th></tr>';
            ...
            while ($row = mysqli_fetch_assoc($results)) {
                ...
                echo '<td>' . $row['physical_address'] . '</td>';
