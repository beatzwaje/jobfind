...
<table border="2">
    ...
    // Prepare and execute an SQL statement to retrieve the job data from the database
...
echo "<tr><th>Job Name</th><th>Job Category</th><th>Department</th><th>Description</th><th>Validation_Date</th><th>Actions</th></tr>";
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td><a href='jobedit.php?id=" . $row["id"] . "'>delete</a></td>"; // Edit button
    echo "</tr>";
}  }
else {
