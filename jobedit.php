...
<body>
  ...
  <div class="logosec">
    ...
    <div class="dropdown-container">
      ...
      <a href="jobedit.php">Edit  and delete job  Listings</a>
      <a href="adddepar.php">Delete Job Listings</a>
...
<div class="form-container">
    ...
    <form action="edit_job.php?id=<?php echo $jobID; ?>" method="POST">
        <div class="form-group">
            ...
            <input type="text" id="job-name" name="job-name" value="<?php echo $existingJobName; ?>" required>
        </div>
        <div class="form-group">
            <label for="job-category">Job Category:</label>
            <input type="text" id="job-category" name="job-category" value="<?php echo $existingJobCategory; ?>" required>
        </div>
        <div class="form-group">
            <label for="department">Department:</label>
            <input type="text" id="department" name="department" value="<?php echo $existingDepartment; ?>" required>
        </div>
        <div class="form-group">
            <label for="description">Description:</label>
            <textarea id="description" name="description" required><?php echo $existingDescription; ?></textarea>
        </div>
        <div class="form-group">
            <label for="validation-date">Validation Date:</label>
            <input type="date" id="validation-date" name="validation-date" value="<?php echo $existingValidationDate; ?>" required>
        </div>
        <div class="form-group">
...
<!-- Display the dashboard or other content here -->
?>
</main>
